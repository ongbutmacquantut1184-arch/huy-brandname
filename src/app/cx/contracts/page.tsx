              ...
              <form onSubmit={handleServiceSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '16px' }}>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                    <input type="checkbox" checked={serviceFormData.ketNoiAPIGateway === 'Có'} onChange={e => setServiceFormData({...serviceFormData, ketNoiAPIGateway: e.target.checked ? 'Có' : ''})} />
                    <span className="label-custom" style={{ margin: 0 }}>Kết nối API Gateway</span>
                  </label>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                    <input type="checkbox" checked={serviceFormData.ketNoiSMPP === 'Có'} onChange={e => setServiceFormData({...serviceFormData, ketNoiSMPP: e.target.checked ? 'Có' : ''})} />
                    <span className="label-custom" style={{ margin: 0 }}>Kết nối SMPP</span>
                  </label>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                    <input type="checkbox" checked={serviceFormData.ketNoiAPIGapOne === 'Có'} onChange={e => setServiceFormData({...serviceFormData, ketNoiAPIGapOne: e.target.checked ? 'Có' : ''})} />
                    <span className="label-custom" style={{ margin: 0 }}>API GapOne</span>
                  </label>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                    <input type="checkbox" checked={serviceFormData.ketNoiViZCA === 'Có'} onChange={e => setServiceFormData({...serviceFormData, ketNoiViZCA: e.target.checked ? 'Có' : ''})} />
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                  <div>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', marginBottom: '8px' }}>
                      <input type="checkbox" checked={!!serviceFormData.ketNoiHeThongKH} onChange={e => setServiceFormData({...serviceFormData, ketNoiHeThongKH: e.target.checked ? 'Có' : ''})} />
                      <span className="label-custom" style={{ margin: 0 }}>Hệ thống KH</span>
                    </label>
                    {!!serviceFormData.ketNoiHeThongKH && (
                      <input className="input-field w-full animate-fade-in" value={serviceFormData.ketNoiHeThongKH} onChange={e => setServiceFormData({...serviceFormData, ketNoiHeThongKH: e.target.value})} placeholder="Nhập thông tin hệ thống..." />
                    )}
                  </div>
                  <div>
                    <label className="label-custom" style={{ marginBottom: '8px', display: 'block' }}>Ghi chú</label>
                    <input className="input-field w-full" value={serviceFormData.ghiChu} onChange={e => setServiceFormData({...serviceFormData, ghiChu: e.target.value})} />
                  </div>
                </div>
